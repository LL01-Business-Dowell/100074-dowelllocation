...
urlpatterns = [
    ...
    path('get-country-collection-v3/', locs_rec_view_2.Collections3.as_view(),name='get-countries-collection-v3'),
    path('add-country-collection-v3/', locs_rec_view_2.AddCollections3.as_view(),name='add-countries-collection-v3'),
